...
namespace savoir.globals
{
    public class GLOBALS
    {
        ...
        public static string[] all_sets_info = File.ReadAllLines(directory + @"\Data\csv_files\The Big 3\sets.csv");
        public static string[] sets_headers = all_sets_info[0].Split(',');
        public static string[] sets_info = all_sets_info[1..];

        public static string[] all_verbs_info = File.ReadAllLines(directory + @"\Data\csv_files\The Big 3\small_conjugations.csv");
